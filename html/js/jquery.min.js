...
(function(e, undefined) {
  ...
  x.fn = x.prototype = {
      ...
      for (
        ...
        if (null != (e = arguments[a])) {
          for (t in e) {
            n = s[t],
              r = e[t],
              s !== r && (l && r && (x.isPlainObject(r) || (i = x.isArray(r)))
    ...
    x.extend({
      ...
      each: function(e, t, n) {
        ...
        if (n) {
          if (s) { for (; o > i; i++) if (r = t.apply(e[i], n), r === !1) break; }
    ...
    function(e, undefined) {
      ...
      s = ot.isXML = function(e) {
          ...
          return t !== p && 9 === t.nodeType && t.documentElement
            ? (p = t,
              ...
              (n.matchesSelector = Q.test(
                m = f.webkitMatchesSelector || f.mozMatchesSelector || f.oMatchesSelector || f.msMatchesSelector,
              )) && ut(function(e) {
                n.disconnectedMatch = m.call(e, "div"), m.call(e, "[s!='']:x"), g.push("!=", I);
              }),
              d = d.length && RegExp(d.join("|")),
              g = g.length && RegExp(g.join("|")),
              y = Q.test(f.contains) || f.compareDocumentPosition
                ? function(e, t) {
                ...
                ? function(e, r) {
                  ...
                  return i
                    ? 1 & i || !n.sortDetached && r.compareDocumentPosition(e) === i
                      ? e === t || y(b, e) ? -1 : r === t || y(b, r) ? 1 : l ? P.call(l, e) - P.call(l, r) : 0
                      : 4 & i
                      ? -1
                      : 1
        ...
        ot.attr = function(e, t) {
          ...
          return o === undefined
            ? n.attributes || !h ? e.getAttribute(t) : (o = e.getAttributeNode(t)) && o.specified ? o.value : null
            : o;
        },
        ot.error = function(e) {
          ...
          preFilter: {
            ...
            PSEUDO: function(e) {
              ...
              return J.CHILD.test(e[0])
                ...
                : (e[3] && e[4] !== undefined
                  ? e[2] = e[4]
                  : n && V.test(n) && (t = gt(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length)
              ...
              return 1 === r && 0 === i
                ...
                : function(t, n, u) {
                  ...
                  if (m) {
                    ...
                    else {while (p = ++h && p && p[g] || (f = h = 0) || d.pop()) {
                        if (
                          (a ? p.nodeName.toLowerCase() === y : 1 === p.nodeType) && ++f
                          && (x && ((p[v] || (p[v] = {}))[e] = [w, f]), p === t)
                        ) break;
                      }}
        ...
        for (; o > l; l++) {
          if (n = i.relative[e[l].type]) f = [yt(vt(f), n)];
            ...
            if (n = i.filter[e[l].type].apply(null, e[l].matches), n[v]) {
              ...
              return bt(
                l > 1 && vt(f),
                l > 1 && mt(e.slice(0, l - 1).concat({ value: " " === e[l - 2].type ? "*" : "" })).replace(z, "$1"),
                n,
                r > l && wt(e.slice(l, r)),
                o > r && wt(e = e.slice(r)),
                o > r && mt(e),
      ...
      remove: function(e, t) {
        ...
        if (t === undefined) this.cache[o] = {};
          ...
          x.isArray(t)
            ...
            : (i = x.camelCase(t), t in s ? r = [t, i] : (r = i, r = r in s ? [r] : r.match(w) || [])), n = r.length;
        ...
        select: {
          get: function(e) {
            ...
            for (; a > u; u++) {
              if (
                n = r[u],
                  !(!n.selected && u !== i || (x.support.optDisabled ? n.disabled : null !== n.getAttribute("disabled"))
      ...
      attr: function(e, t, n) {
        ...
        if (e && 3 !== s && 8 !== s && 2 !== s) {
          return typeof e.getAttribute === r
            ? x.prop(e, t, n)
            : (1 === s && x.isXMLDoc(e)
              || (t = t.toLowerCase(), i = x.attrHooks[t] || (x.expr.match.bool.test(t) ? M : R)),
              n === undefined
                ? i && "get" in i && null !== (o = i.get(e, t)) ? o : (o = x.find.attr(e, t), null == o ? undefined : o)
                : null !== n
                ? i && "set" in i && (o = i.set(e, n, t)) !== undefined ? o : (e.setAttribute(t, n + ""), n)
      ...
      prop: function(e, t, n) {
        ...
        if (e && 3 !== s && 8 !== s && 2 !== s) {
          return o = 1 !== s || !x.isXMLDoc(e),
            ...
            n !== undefined
              ? i && "set" in i && (r = i.set(e, n, t)) !== undefined ? r : e[t] = n
  ...
  x.event = {
      ...
      if (m && (u = m.events)) {
        ...
        while (l--) {
          if (a = X.exec(t[l]) || [], h = g = a[1], d = (a[2] || "").split(".").sort(), h) {
            ...
            while (o--) {
              c = f[o],
                !i && g !== c.origType || n && n.guid !== c.guid || a && !a.test(c.namespace)
                || r && r !== c.selector && ("**" !== r || !c.selector)
                || (f.splice(o, 1), c.selector && f.delegateCount--, p.remove && p.remove.call(e, c));
            }
            s && !f.length
              && (p.teardown && p.teardown.call(e, d, m.handle) !== !1 || x.removeEvent(e, h, m.handle), delete u[h]);
    ...
    trigger: function(t, n, r, i) {
      ...
      if (
        a = u = r = r || o,
          3 !== r.nodeType && 8 !== r.nodeType && !_.test(d + x.event.triggered)
        ...
        return t.type = d,
          i || t.isDefaultPrevented() || f._default && f._default.apply(h.pop(), n) !== !1 || !x.acceptData(r)
      ...
      filter: function(e, t) {
        ...
        return null == e.pageX && null != t.clientX
          && (n = e.target.ownerDocument || o,
            r = n.documentElement,
            i = n.body,
            e.pageX = t.clientX + (r && r.scrollLeft || i && i.scrollLeft || 0)
              - (r && r.clientLeft || i && i.clientLeft || 0),
            e.pageY = t.clientY + (r && r.scrollTop || i && i.scrollTop || 0)
    ...
    x.fn.extend({
      on: function(e, t, n, r, i) {
        ...
        if (
          null == n && null == r
            ? (r = t, n = t = undefined)
            : null == r && ("string" == typeof t ? (r = n, n = undefined) : (r = n, n = t, t = undefined)), r === !1
        ) r = Y;
  ...
  x.fn.extend({
    ...
    index: function(e) {
      return e
        ? "string" == typeof e ? g.call(x(e), this[0]) : g.call(this, e.jquery ? e[0] : e)
        ...
        if (
          ...
          if (s) {
            for (u = o[o.length - 1].ownerDocument, x.map(o, ht), l = 0; s > l; l++) {
              a = o[l],
                at.test(a.type || "") && !q.access(a, "globalEval") && x.contains(u, a)
  ...
  function Rt(e) {
    ...
    return n || (n = Mt(e, t),
      "none" !== n && n
      || (xt = (xt || x("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important"))
  ...
  x.fn.extend({
    ...
    serializeArray: function() {
      return this.map(function() {
        ...
        var e = this.type;
        return this.name && !x(this).is(":disabled") && zt.test(this.nodeName) && !It.test(e)
  ...
  x.fn.load = function(e, t, n) {
    ...
    return a >= 0 && (r = e.slice(a), e = e.slice(0, a)),
      ...
      s.length > 0 && x.ajax({ url: e, type: i, dataType: "html", data: t }).done(function(e) {
      ...
      ajax: function(e, t) {
        ...
        if (
          h.promise(T).complete = d.add,
            ...
            && (a = tn.exec(c.url.toLowerCase()),
              c.crossDomain = !(!a
                || a[1] === Xt[1] && a[2] === Xt[2]
                  && (a[3] || ("http:" === a[1] ? "80" : "443")) === (Xt[3] || ("http:" === Xt[1] ? "80" : "443")))),
        ...
        u = c.global,
          ...
          || (c.data && (r = c.url += (Vt.test(r) ? "&" : "?") + c.data, delete c.data),
            c.cache === !1
            && (c.url = Jt.test(r) ? r.replace(Jt, "$1_=" + Yt++) : r + (Vt.test(r) ? "&" : "?") + "_=" + Yt++)),
          c.ifModified
  ...
  x.ajaxSetup({
    ...
    x.ajaxTransport("script", function(e) {
      if (e.crossDomain) {
        ...
        return {
          send: function(r, i) {
            t = x("<script>").prop({ async: !0, charset: e.scriptCharset, src: e.url }).on(
              "load error",
              n = function(e) {
  ...
  x.ajaxSetup({
    ...
    x.ajaxPrefilter("json jsonp", function(t, n, r) {
      var i,
        o,
        s,
        a = t.jsonp !== !1 && (dn.test(t.url)
          ? "url"
          : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded")
            && dn.test(t.data) && "data");
