...
//!
//! This chapter explores state and mutation:
//! - Assignment and local state (RefCell, Mutex)
//! - The environment model (ownership, lifetimes)
//! - Mutable data (interior mutability)
